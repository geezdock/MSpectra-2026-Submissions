...
class Settings:
    ...
    interview_turn_provider: str = os.getenv("INTERVIEW_TURN_PROVIDER", "heuristic").strip().lower()
    ...
    groq_interview_max_tokens: int = int(os.getenv("GROQ_INTERVIEW_MAX_TOKENS", "300"))
